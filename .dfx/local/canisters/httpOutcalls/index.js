...
export const canisterId = process.env.CANISTER_ID_HTTPOUTCALLS;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./httpOutcalls.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the httpOutcalls canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./httpOutcalls.did.js")._SERVICE>}
 */
