...
import { idlFactory } from './fileUpload.did.js';
export { idlFactory } from './fileUpload.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.FILEUPLOAD_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./fileUpload.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the fileUpload canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./fileUpload.did.js")._SERVICE>}
 */
export const fileUpload = createActor(canisterId);
